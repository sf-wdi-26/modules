...
- `⌘ + ⌥ + i` to open the DevTools

If you forget this command, you can go to *View > Developer > Developer Tools*, but try to memorize the keyboard shortcut.
...
- [**Elements**](https://developer.chrome.com/devtools/docs/dom-and-styles): Edit the DOM
...
- [**Profiles**](https://developer.chrome.com/devtools/docs/profiles): Identify optimizations in the performace of an app or webpage.
